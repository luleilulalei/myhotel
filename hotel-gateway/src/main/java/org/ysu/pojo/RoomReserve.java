...
public class RoomReserve {
    ...
    public RoomReserve(Integer id, String no, String roomNumber, Integer roomTypeId, BigDecimal standardPrice, BigDecimal discountPrice, BigDecimal deposit, String customerName, Integer cardType, String cardNumber, String phone, String arriveTime, String leaveTime, Integer customerSize, Integer userId, Integer customerId, BigDecimal customerPrice, Integer state, String note) {
        this.id = id;
        this.no = no;

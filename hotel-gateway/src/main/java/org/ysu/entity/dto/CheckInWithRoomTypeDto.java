package org.ysu.entity.dto;

import java.math.BigDecimal;

public class CheckInWithRoomTypeDto {
    private Integer id;
    ...
    public CheckInWithRoomTypeDto(Integer id, String no, String roomNumber, Integer roomTypeId, BigDecimal standardPrice, BigDecimal discountPrice, BigDecimal deposit, String customerName, Integer cardType, String cardNumber, String phone, String arriveTime, String leaveTime, Integer customerSize, Integer userId, Integer customerId, BigDecimal customerPrice, Integer breakfastOrNot, Integer remindOrNot, String note, String roomTypeName) {
        this.id = id;
        this.no = no;
    ...
    public String toString() {
        return "CheckInWithRoomTypeDto{" +
                ...
                ", breakfastOrNot=" + breakfastOrNot +
                ", remindOrNot=" + remindOrNot +
                ", note='" + note + '\'' +
